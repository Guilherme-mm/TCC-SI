...
implementação destes softwares \citeauthoronline{2-CFSurvey} destacam:
...
O artigo de \citeauthoronline{2-CFSurvey} apresenta uma revisão das principais tecnologias e métodos utilizados em sistemas de recomendação. O trabalho faz uma 
